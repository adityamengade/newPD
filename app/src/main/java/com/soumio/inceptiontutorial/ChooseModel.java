...
public class ChooseModel extends AppCompatActivity {
    ...
    private Button inceptionWave;
    private Button inceptionSpiral;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inceptionWave = (Button)findViewById(R.id.inception_float);
        inceptionWave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // filename in assets
                chosen = "wave_model.tflite";
        ...
        inceptionSpiral = (Button)findViewById(R.id.inception_quant);
        inceptionSpiral.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // filename in assets
                chosen = "spiral_model.tflite";
                // model in not quantized
                quant = false;
                // open camera
                openCameraIntent();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(requestCode == REQUEST_IMAGE && resultCode == RESULT_OK) {
            try {
                ...
                if(quant) {
                    Crop.of(source_uri, dest_uri).withAspect(512, 256).start(ChooseModel.this);
                }
                else
        ...
        // if cropping acitivty is finished, get the resulting cropped image uri and send it to 'Classify' activity
            ...
            Intent i;
            if(quant){
                i = new Intent(ChooseModel.this, WaveClassify.class);
            }
            else {
                i = new Intent(ChooseModel.this, Classify.class);
            }
